...
def bookRoom(request):
        ...
        #    Store details in booking table in database
        newBooking = Booking(
            user=userInstance, roomNo=roomInstance, guestName=name, roomType=roomType, capacity=capacity, checkInDate=checkIn, checkOutDate=checkOut
        )
        newBooking.save()
        ...
        #     email.send()
        return render(request, 'error_page.html', {"error": "Hola! Room Booked Successfully."})
